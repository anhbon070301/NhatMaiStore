<head>
  ...
  <link href="{{ asset('css/assets/vendor/quill/quill.snow.css') }}" rel="stylesheet">
  <link href="{{ asset('css/assets/vendor/quill/quill.bubble.css') }}" rel="stylesheet">
  <link href="{{ asset('css/assets/vendor/remixicon/remixicon.css') }}" rel="stylesheet">
  <link href="{{ asset('css/assets/vendor/simple-datatables/style.css') }}" rel="stylesheet">
  ...
  * License: https://bootstrapmade.com/license/
  ======================================================== -->
  <script src="{{ asset('css/assets/vendor/tinymce/tinymce.min.js') }}"></script>
